public class App {
  ...
  EBook umSussuroNasTrevas =  new EBook("Um Sussuro nas trevas", 147);

  umSussuroNasTrevas.irParaPagina(146);
  System.out.println(umSussuroNasTrevas.lendoPagina == 146);
  umSussuroNasTrevas.virarPagina();
  System.out.println(umSussuroNasTrevas.lendoPagina == 147);
  umSussuroNasTrevas.voltarPagina();
  System.out.println(umSussuroNasTrevas.lendoPagina == 146);
  umSussuroNasTrevas.virarPagina();
  System.out.println(umSussuroNasTrevas.lendoPagina == 147);
  ...
  try {
    umSussuroNasTrevas.irParaPagina(148);
    System.out.println(false);
  } catch (IllegalArgumentException e) {
    System.out.println(true + " " + e);
  }
